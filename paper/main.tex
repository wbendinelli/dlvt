...
\input{chapters/03_mathematical_formulation}
\input{chapters/04_analysis_results}
\input{chapters/05_discussion}
\input{chapters/06_empirical_program}
...
\input{appendices/A01_positive_invariance}
\setcounter{section}{3}% next section prints as A4
\input{appendices/A04_equilibrium_algebra}
\input{appendices/A05_jacobian_stability}
\input{appendices/A06_carrying_capacity}
\input{appendices/A07_regularization_audit}
\input{appendices/A08_bifurcation_interval}
\input{appendices/A09_epsilon_extrapolation}
\input{appendices/A10_global_stability}
\input{appendices/A11_fast_slow}
